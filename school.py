    ...
    try:
        ...
        if data['total'] > 0 and data['total'] < 400:
            ...
            for result in data['results']:
                try:
                    if result['name'] not in name and (result['detail_info']['tag'] == '教育培训;高等院校' or  result['detail_info']['tag'] == '教育培训;中学' or result['detail_info']['tag'] == '教育培训;小学' or result['detail_info']['tag'] == '教育培训;幼儿园' or result['detail_info']['tag'] == '教育培训;成人教育' or result['detail_info']['tag'] == '教育培训;亲子教育' or result['detail_info']['tag'] == '教育培训;特殊教育学校' or result['detail_info']['tag'] == '教育培训;培训机构' ):
                        if not (result['name'].find('大学') != -1 and result['name'].find('中心') != -1):
                            if not (result['name'].find('大学') != -1 and result['name'].find('院') != -1):
                                if not (result['name'].find('大学') != -1 and result['name'].find('厅') != -1):
                                    if not (result['name'].find('大学') != -1 and result['name'].find('区') != -1):
                                        if not (result['name'].find('大学') != -1 and result['name'].find('班') != -1):
                                            if not (result['name'].find('大学') != -1 and result['name'].find('楼') != -1):
                                                if not (result['name'].find('大学') != -1 and result['name'].find('站') != -1):
                                                    if not (result['name'].find('大学') != -1 and result['name'].find('房') != -1):
                                                        if not (result['name'].find('大学') != -1 and result['name'].find('室') != -1):
                                                            if not (result['name'].find('大学') != -1 and result['name'].find('处') != -1):
                                                                if not (result['name'].find('大学') != -1 and result['name'].find('所') != -1):
                                                                    if not (result['name'].find('大学') != -1 and result['name'].find('工厂') != -1):
                                                                        if not (result['name'].find('大学') != -1 and result['name'].find('办') != -1):
                                                                            if not (result['name'].find('大学') != -1 and result['name'].find('停车场') != -1):
                                                                                if not (result['name'].find('大学') != -1 and result['name'].find('会') != -1):
...
def func_school(city, branch_no, baidu_ak, radius, workbook):
